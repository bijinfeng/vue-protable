...
import AntdSelectWrapper from '../src/AntdSelectWrapper.vue';

describe('AntdSelectWrapper', () => {
  it('renders with array options', () => {
    const wrapper = mount(AntdSelectWrapper, {
      props: {
        value: 'option1',
        options: [
  ...
  it('renders with object options', () => {
    const wrapper = mount(AntdSelectWrapper, {
      props: {
        value: 'status1',
        options: {
          status1: { text: 'Status 1', status: 'success' },
          status2: { text: 'Status 2', status: 'error' },
        },
      },
    });
